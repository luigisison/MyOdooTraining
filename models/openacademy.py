...
# class name uses camelback style
# Create a class called Course which inherits from the Odoo frammodels.Model
class OpenAcademyCourse(models.Model):

    # Mandatory. The name that Odoo will refer to. Name of the table. Use "dot" as term separator. Use lower case.
...
class OpenAcademySession(models.Model):
    ...
    #Enable followers. class=oe_chatter
    ...
    rem_seat_per = fields.Float(compute="_compute_totalseats", string="Remaining Seats")
